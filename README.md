# TensorflowEfficientUNet-Segmentation-Ovarian-Tumor (2023/08/01)
<h2>
1 TensorflowEfficientUNet-Segmentation-Ovarian-Tumor 
</h2>
<p>
This is an experimental project detect Mammogram  by using 
TensorflowEfficientUNetModel,which is a Tensorflow 2 implementation based on 
<b>
<a href="https://github.com/he44/EfficientNet-UNet">he44/EfficientNet-UNet</a></b>

</p>
In order to write the <a href="./TensorflowEfficientUNet.py">TensorflowEfficientUNet</a> Python class, we have used the Python code in the following web sites.
</p>
<pre>
1.he44/EfficientNet-UNet
...
3. Image-Segmentation-CDD-CESM-Mammogram
...
<br>
<h2>
2. Install TensorflowEfficientUNet-Segmentation-Ovarian-Tumor
</h2>
Please clone TensorflowEfficientUNet-Segmentation-Ovarian-Tumor.git in a folder <b>c:\google</b>.<br>
<pre>
>git clone https://github.com/sarah-antillia/TensorflowEfficientUNet-Segmentation-Ovarian-Tumor.git<br>
</pre>
...
<h2>
4 Train TensorflowEfficientUNet Model
</h2>
...
<pre>
>python ../../TensorflowEfficientUNetTrainer.py ./train_eval_infer.config
</pre>
, where train_eval_infer.config is the following.
<pre>
; train_eval_infer.config
; Dataset of Ovarian-Tumor
; 2023/07/31 antillia.com
...
<img src="./asset/train_console_output_at_epoch_35_0731.png" width="720" height="auto"><br>
<br>
<br>
...
, which simply runs the following command.<br>
<pre>
>python ../../TensorflowEfficientUNetEvaluator.py ./train_eval_infer.config
</pre>
The evaluation result is the following.<br>
<img src="./asset/evaluate_console_output_at_epoch_35_0731.png" width="720" height="auto"><br>
<br>
...
, which simply runs the following command.<br>
<pre>
>python ../../TensorflowEfficientUNetInferencer.py ./train_eval_infer.config
</pre>
